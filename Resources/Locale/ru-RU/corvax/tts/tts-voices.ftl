...
tts-voice-name-portal_cave_johnson = Cave johnson (Portal)
tts-voice-name-Ninja_Turtles_shredder = Shredder (Teenage mutant ninja turtle)
tts-voice-name-Star_Wars_Han_Solo = Han Solo (Star Wars)
tts-voice-name-Star_Wars_Darth_Sidious = Darth Sidious (Star Wars)
tts-voice-name-Star_Wars_Luke_Skywalker = Luke Skywalker (Star Wars)
tts-voice-name-Star_Wars_Yoda = Yoda (Star Wars)
tts-voice-name-Star_Wars_Darth_Vader = Darth Vader (Star Wars)
tts-voice-name-Star_Wars_Obi-Wan_Kenobi = Obi-wan Kenobi (Star Wars)
tts-voice-name-Star_Wars_Anakin_Skywalker = Anakin Skywalker (Star Wars)
tts-voice-name-Transformers_War_of_Cybertron_optimusprime = Optimus Prime (Transformers)
tts-voice-name-Transformers_War_of_Cybertron_megatron = Megatron (Transformers)
tts-voice-name-Transformers_War_of_Cybertron_soundwave = Soundwave (Transformers)
tts-voice-name-The_Lord_of_the_Rings_Aragorn = Aragorn (The Lord of the rings)
tts-voice-name-The_Lord_of_the_Rings_Elrond = Elrond (The Lord of the rings)
tts-voice-name-The_Lord_of_the_Rings_Gandalf = Gandalf (The Lord of the rings)
tts-voice-name-The_Lord_of_the_Rings_Gimli = Gimli (The Lord of the rings)
tts-voice-name-The_Lord_of_the_Rings_Gollum = Gollum (The Lord of the rings)
tts-voice-name-The_Lord_of_the_Rings_Legolas = Legolas (The Lord of the rings)
tts-voice-name-Srek_Gingerbread_Man = Gingerbread Man (Shrek)
tts-voice-name-Srek_Fiona = Fiona (Shrek)
tts-voice-name-Srek_Donkey = Donkey (Shrek)
tts-voice-name-Srek_Fairy_Godmother = Fairy Godmother (Shrek)
tts-voice-name-Srek_King = King (Shrek)
tts-voice-name-Srek_Narrator = Narrator (Shrek)
tts-voice-name-Srek_Puss_in_Boots = Puss in Boots (Shrek)
tts-voice-name-Srek_Shrek = Shrek (Shrek)
tts-voice-name-Pirats_of_the_caribbean_Jack_Sparrow = Jack Sparrow (Pirates of the Caribbean)
tts-voice-name-Pirats_of_the_caribbean_Barbossa = Barbossa (Pirates of the Caribbean)
tts-voice-name-Pirats_of_the_caribbean_Tiadalma = Tiadalma (Pirates of the Caribbean)
tts-voice-name-Pirats_of_the_caribbean_Davy_Jones = Davy Jones (Pirates of the Caribbean)
tts-voice-name-Harry_Potter_Sirius_Black = Sirius Black (Harry Potter)
tts-voice-name-Harry_Potter_Dobby = Dobby (Harry Potter)
tts-voice-name-Harry_Potter_Severus_Snape_film = Злодеус Злей(фильм) (Harry Potter)
tts-voice-name-Harry_Potter_Harry_Potter = Harry Potter (Harry Potter)
tts-voice-name-Harry_Potter_Albus_Dumbledore = Albus Dumbledore (Harry Potter)
tts-voice-name-Harry_Potter_Lord_Voldemort = Voldemort (Harry Potter)
tts-voice-name-Harry_Potter_Severus_Snape = Злодеус Злей (Harry Potter)
tts-voice-name-Harry_Potter_Filius_Flitwick = Filius Flitwick (Harry Potter)
tts-voice-name-Harry_Potter_Minerva_McGonagall = Minnerva McGonagall (Harry Potter)
tts-voice-name-Harry_Potter_Horace_Slughorn = Horace Slughorn (Harry Potter)
tts-voice-name-Harry_Potter_Cedric = Cedric (Harry Potter)
tts-voice-name-Harry_Potter_Alastor_Mad-Eye_Moody = Alastor Mad-eye Moody (Harry Potter)
tts-voice-name-X3_reunion_Betty = Betty (X3)
tts-voice-name-Overlord_2_Gnarl = Gnarl (The Overlord 2)
tts-voice-name-Marvel_Tony_Stark = Tony Stark (Marvel)
tts-voice-name-Dragons_Sabellian = Sabellian (World of Warcraft)
tts-voice-name-Dragons_Ysera = Ysera (World of Warcraft)
tts-voice-name-Dragons_MalygosWrath_of_the_Lich_King = Malygos(WOTLK) (World of Warcraft)
tts-voice-name-Dragons_Ebyssian = Ebyssian (World of Warcraft)
tts-voice-name-Dragons_Deathwing = Deathwing (World of Warcraft)
tts-voice-name-Dragons_Nozdormu = Nozdormu (World of Warcraft)
tts-voice-name-Dragons_Malygos = Malygos (World of Warcraft)
tts-voice-name-Draconids_Calderax = Calderax (World of Warcraft)
tts-voice-name-Draconids_Bazentus = Bazentus (World of Warcraft)
tts-voice-name-Draconids_Kazra = Kazra (World of Warcraft)
tts-voice-name-Draconids_Seltherex = Seltherex (World of Warcraft)
tts-voice-name-Draconids_Sendrax = Sendrax (World of Warcraft)
tts-voice-name-Draconids_Evantkis = Evantkis (World of Warcraft)
tts-voice-name-Draconids_Drine = Drine (World of Warcraft)
tts-voice-name-Draconids_Lethanak = Lethanak (World of Warcraft)
tts-voice-name-Dragons2_Wrathion_echo = Wrathion(echo) (World of Warcraft)
tts-voice-name-Dragons2_Alexstraza = Alexstraza (World of Warcraft)
tts-voice-name-Dragons2_Kalecgos = Kalecgos (World of Warcraft)
tts-voice-name-Dragons2_Wrathion = Wrathion (World of Warcraft)
tts-voice-name-Dragons2_Kalecgos_echo = Kalecgos(echo) (World of Warcraft)
tts-voice-name-Dragons2_Alextraza_echo = Alextraza(echo) (World of Warcraft)
tts-voice-name-Dragons2_Neltharion_echo = Neltharion(echo) (World of Warcraft)
tts-voice-name-Dragons2_Wrathion_Deathwing = Wration Deathwing (World of Warcraft)
tts-voice-name-Dragons2_Neltharion = Neltharion (World of Warcraft)
tts-voice-name-en_Gale = Gale (Baldur's gate 3)
tts-voice-name-en_Jaheira = Jaheira (Baldur's gate 3)
tts-voice-name-en_Laezel = Laezel (Baldur's gate 3)
tts-voice-name-en_Karlach = Karlach (Baldur's gate 3)
tts-voice-name-en_Shadowheart = Shadowheart (Baldur's gate 3)
tts-voice-name-en_Wyll = Wyll (Baldur's gate 3)
tts-voice-name-en_Minthara = Minthara (Baldur's gate 3)
tts-voice-name-en_Minsc = Minsc (Baldur's gate 3)
tts-voice-name-en_Astarion = Astarion (Baldur's gate 3)
tts-voice-name-en_Halsin = Halsin (Baldur's gate 3)
tts-voice-name-en_Emperor = Emperor (Baldur's gate 3)
tts-voice-name-en_Ketheric = Ketheric (Baldur's gate 3)
tts-voice-name-en_Gortash = Gortash (Baldur's gate 3)
